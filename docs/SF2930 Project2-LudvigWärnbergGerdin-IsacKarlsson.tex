...
\label{sec:orgddeb738}
\subsection{Background}
\label{sec:org4fb220e}
...
the total premium of 90\%. Lastly we calculate the base level \(\gamma_0\) from the formula given in (\ref{eq:org0b2006c})

\section{Methods and Methodological Considerations}
\label{sec:org9ca4c37}
