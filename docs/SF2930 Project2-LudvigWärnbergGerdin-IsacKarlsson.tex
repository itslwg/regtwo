...
the total premium of 90\%. Lastly we calculate the base level \(\gamma_0\) from the formula given in (\ref{eq:org35c57d9})

\section{Methods and Methodological Considerations}
\label{sec:org7f03a32}
